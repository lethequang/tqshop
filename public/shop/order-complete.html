      ...
      <div class="row">
        <div class="col-12">
          <div class="checkout-step mb-40">
            <ul>
              <li> <a href="checkout.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/checkout.html">
                <div class="step">
                  <div class="line"></div>
                  <div class="circle">1</div>
                </div>
                <span>Shipping</span> </a> </li>
              <li> <a href="order-overview.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/order-overview.html">
                <div class="step">
                  <div class="line"></div>
                  <div class="circle">2</div>
                </div>
                <span>Order Overview</span> </a> </li>
              <li> <a href="payment.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/payment.html">
                <div class="step">
                  <div class="line"></div>
                  <div class="circle">3</div>
                </div>
                <span>Payment</span> </a> </li>
              <li class="active"> <a href="order-complete.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/order-complete.html">
                <div class="step">
                  <div class="line"></div>
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <a href="product-page.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/product-page.html">
                                <div class="product-image">
                                  <img alt="Stylexpo" src="images/1.jpg" tppabs="http://aaryaweb.info/html/stylexpo/stx004/images/1.jpg">
                                </div>
                              </a>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <a href="product-page.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/product-page.html">
                                <div class="product-image">
                                  <img alt="Stylexpo" src="images/2.jpg" tppabs="http://aaryaweb.info/html/stylexpo/stx004/images/2.jpg">
                                </div>
                              </a>
                            </td>
                            <td>
                  ...
                  <div class="col-12">
                    <div class="print-btn">
                      ...
                      <div class="right-side float-none-xs mt-sm-30"> 
                        <a class="btn btn-black" href="shop.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/shop.html">
