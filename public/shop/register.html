            ...
            <div class="col-xl-6 col-lg-8 col-md-8 ">
              <form class="main-form full">
                <div class="row">
                  ...
                  <div class="col-12">
                    <hr>
                    <div class="new-account align-center mt-20"> <span>Already have an account with us</span> <a class="link" title="Register with Stylexpo" href="login.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/login.html">Login Here</a> </div>
                  </div>
                </div>
              </form>
            </div>
