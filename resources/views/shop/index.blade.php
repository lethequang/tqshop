	...
	<section class="banner-mobile">
		<div class="banner">
			<div class="main-banner">
				<div class="banner-1"> <img src="shop/images/banner1.jpg" alt="Stylexpo">
				...
				<div class="banner-2"> <img src="shop/images/banner2.jpg" alt="Stylexpo">
					<div class="banner-detail">
						<div class="container">
							<div class="row">
								<div class="col-8">
				...
				<div class="banner-3"> <img src="shop/images/banner3.jpg" alt="Stylexpo">
					<div class="banner-detail">
						<div class="container">
							<div class="row">
			...
			<div class="col-xl-2 col-lg-3 col-xl-20per mt-30 left-side float-none-sm ">
				<div class="sidebar-block open1">
							...
							<div class="row">
								<div id="sidebar-product" class="owl-carousel">
									<div class="item">
										<ul>
											<li>
												<div class="pro-media"> <a><img alt="T-shirt" src="shop/images/1.jpg"></a> </div>
											...
											<li>
												<div class="pro-media"> <a><img alt="T-shirt" src="shop/images/2.jpg"></a> </div>
												<div class="pro-detail-info"> <a>Black African Print</a>
													<div class="rating-summary-block">
														<div class="rating-result" title="53%"> <span style="width:53%"></span> </div>
													</div>
											...
											<li>
												<div class="pro-media"> <a><img alt="T-shirt" src="shop/images/3.jpg"></a> </div>
												<div class="pro-detail-info"> <a>Black African Print</a>
													<div class="rating-summary-block">
														<div class="rating-result" title="53%"> <span style="width:53%"></span> </div>
													</div>
									...
									<div class="item">
										<ul>
											<li>
												<div class="pro-media"> <a><img alt="T-shirt" src="shop/images/4.jpg"></a> </div>
												<div class="pro-detail-info"> <a>Black African Print</a>
													<div class="rating-summary-block">
														<div class="rating-result" title="53%"> <span style="width:53%"></span> </div>
													</div>
											...
											<li>
												<div class="pro-media"> <a><img alt="T-shirt" src="shop/images/5.jpg"></a> </div>
												<div class="pro-detail-info"> <a>Black African Print</a>
													<div class="rating-summary-block">
														<div class="rating-result" title="53%"> <span style="width:53%"></span> </div>
													</div>
											...
											<li>
												<div class="pro-media"> <a><img alt="T-shirt" src="shop/images/6.jpg"></a> </div>
												<div class="pro-detail-info"> <a>Black African Print</a>
													<div class="rating-summary-block">
														<div class="rating-result" title="53%"> <span style="width:53%"></span> </div>
													</div>
									...
									<div class="item">
										<ul>
											<li>
												<div class="pro-media"> <a><img alt="T-shirt" src="shop/images/7.jpg"></a> </div>
												<div class="pro-detail-info"> <a>Black African Print</a>
													<div class="rating-summary-block">
														<div class="rating-result" title="53%"> <span style="width:53%"></span> </div>
													</div>
											...
											<li>
												<div class="pro-media"> <a><img alt="T-shirt" src="shop/images/8.jpg"></a> </div>
												<div class="pro-detail-info"> <a>Black African Print</a>
													<div class="rating-summary-block">
														<div class="rating-result" title="53%"> <span style="width:53%"></span> </div>
													</div>
											...
											<li>
												<div class="pro-media"> <a><img alt="T-shirt" src="shop/images/9.jpg"></a> </div>
												<div class="pro-detail-info"> <a>Black African Print</a>
													<div class="rating-summary-block">
														<div class="rating-result" title="53%"> <span style="width:53%"></span> </div>
													</div>
					...
					<div class="sidebar-box sub-banner left-banner  mb-30 mb-sm-15 d-none d-lg-block">
						<a href="#">
							<img src="shop/images/left-banner.jpg" alt="Beaox">
						</a>
					</div>
									...
									<div class="item client-detail">
										<div class="quote right-side">
											<div class="quote1-img">
												<img src="shop/images/quote1.png" alt="Beaox">
											</div>
											...
											<div class="quote2-img">
												<img src="shop/images/quote2.png" alt="Beaox">
											</div>
										</div>
										<div class="client-img left-side ">
											<h4 class="sub-title client-title">- Joseph deboungawer - </h4>
											<img alt="Beaox" src="shop/images/testimonial_img1.jpg">
										</div>
									</div>
									<div class="item client-detail">
										<div class="quote right-side">
										...
										<div class="client-img left-side ">
											<h4 class="sub-title client-title">- Joseph deboungawer - </h4>
											<img alt="Beaox" src="shop/images/testimonial_img2.jpg">
										</div>
									</div>
									<div class="item client-detail">
										<div class="quote right-side">
										...
										<div class="client-img left-side ">
											<h4 class="sub-title client-title">- Joseph deboungawer - </h4>
											<img alt="Beaox" src="shop/images/testimonial_img3.jpg">
										</div>
									</div>
								</div>
							</div>
					...
					<div class="sidebar-box d-none d-lg-block  mb-30">
						<div class="video-bg">
							<div class="video-delail align-center">
								<img src="shop/images/video-bg.jpg" alt="Beaox">
								<div class="video-delail-inner">
									<div class="video-block">
										<a class="popup-youtube" href="javascript:if(confirm(https://player.vimeo.com/video/19228643))">
											<img alt="Beaox" src="shop/images/you-tube-icon.png" draggable="false">
										</a>
									</div>
								...
								<div id="blog"  class="owl-carousel">
										...
										<div class="blog-item">
											<div class="">
												<div class="blog-media">
													<img src="shop/images/blog_img1.jpg" alt="Beaox">
									...
									<div class="item">
										<div class="blog-item">
											<div class="">
												<div class="blog-media">
													<img src="shop/images/blog_img2.jpg" alt="Beaox">
													<div class="blog-effect"></div>
													<a href="single-blog.html" title="Click For Read More" class="read">&nbsp;</a>
													<div class="effect"></div>
												</div>
									...
									<div class="item">
										<div class="blog-item">
											<div class="">
												<div class="blog-media">
													<img src="shop/images/blog_img3.jpg" alt="Beaox">
													<div class="blog-effect"></div>
													<a href="single-blog.html" title="Click For Read More" class="read">&nbsp;</a>
													<div class="effect"></div>
												</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="sub-banner sub-banner1" >
									<img alt="Stylexpo" src="shop/images/sub-banner1.jpg">
							...
							<div class="col-md-6 mt-xs-30">
								<div class="">
									<div class="sub-banner sub-banner2">
										<img alt="Stylexpo" src="shop/images/sub-banner2.jpg">
										<div class="sub-banner-detail">
							...
							<div id="top-cat-pro" class="owl-carousel sell-pro align-center">
								<div class="item ">
									<div class="item-inner">
										<img src="shop/images/cate_1.jpg" alt="Stylexpo">
								...
								<div class="item ">
									<div class="item-inner">
										<img src="shop/images/cate_2.jpg" alt="Stylexpo">
										<div class="cate-detail">
											<div>cosmetics</div>
											<a class="btn btn-white" href="shop.html">View Products</a>
										</div>
								...
								<div class="item ">
									<div class="item-inner">
										<img src="shop/images/cate_3.jpg" alt="Stylexpo">
										<div class="cate-detail">
											<div>lingerie</div>
											<a class="btn btn-white" href="shop.html">View Products</a>
										</div>
								...
								<div class="item ">
									<div class="item-inner">
										<img src="shop/images/cate_4.jpg" alt="Stylexpo">
										<div class="cate-detail">
											<div>Men’s shoes</div>
											<a class="btn btn-white" href="shop.html">View Products</a>
										</div>
								...
								<div class="item ">
									<div class="item-inner">
										<img src="shop/images/cate_5.jpg" alt="Stylexpo">
										<div class="cate-detail">
											<div>kid's wear</div>
											<a class="btn btn-white" href="shop.html">View Products</a>
										</div>
								...
								<div class="item ">
									<div class="item-inner">
										<img src="shop/images/cate_6.jpg" alt="Stylexpo">
										<div class="cate-detail">
											<div>sunglasses</div>
											<a class="btn btn-white" href="shop.html">View Products</a>
										</div>
								...
								<div class="item ">
									<div class="item-inner">
										<img src="shop/images/cate_7.jpg" alt="Stylexpo">
										<div class="cate-detail">
											<div>Men’s shirt</div>
											<a class="btn btn-white" href="shop.html">View Products</a>
										</div>
								...
								<div class="item ">
									<div class="item-inner">
										<img src="shop/images/cate_8.jpg" alt="Stylexpo">
										<div class="cate-detail">
								...
								<div class="item ">
									<div class="item-inner">
										<img src="shop/images/cate_9.jpg" alt="Stylexpo">
										<div class="cate-detail">
											<div>watches</div>
											<a class="btn btn-white" href="shop.html">View Products</a>
										</div>
								...
								<div class="item ">
									<div class="item-inner">
										<img src="shop/images/cate_10.jpg" alt="Stylexpo">
										<div class="cate-detail">
					...
					<div class="row m-0">
						<div class="col-lg-6 p-0">
							<div class="sub-banner small-banner small-banner1">
								<a href="#">
									<img src="shop/images/small-banner1.jpg" alt="Stylexpo">
								</a>
							</div>
						</div>
						<div class="col-lg-6 p-0 mt-sm-30">
							<div class="sub-banner small-banner small-banner2">
								<a href="#">
									<img src="shop/images/small-banner2.jpg" alt="Stylexpo">
								</a>
							</div>
						</div>
					</div>
					...
					<div class="row brand">
						<div class="col-md-12">
							<div id="brand-logo" class="owl-carousel align_center">
								<div class="item"><a href="#"><img src="shop/images/brand1.png" alt="Stylexpo"></a></div>
								<div class="item"><a href="#"><img src="shop/images/brand2.png" alt="Stylexpo"></a></div>
								<div class="item"><a href="#"><img src="shop/images/brand3.png" alt="Stylexpo"></a></div>
								<div class="item"><a href="#"><img src="shop/images/brand4.png" alt="Stylexpo"></a></div>
								<div class="item"><a href="#"><img src="shop/images/brand5.png" alt="Stylexpo"></a></div>
								<div class="item"><a href="#"><img src="shop/images/brand6.png" alt="Stylexpo"></a></div>
								<div class="item"><a href="#"><img src="shop/images/brand7.png" alt="Stylexpo"></a></div>
								<div class="item"><a href="#"><img src="shop/images/brand8.png" alt="Stylexpo"></a></div>
							</div>
						</div>
					</div>
				</div>
