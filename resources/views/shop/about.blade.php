...
<div class="main"> 
            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="partner-block mb-sm-30 light-gray-bg">
                  <ul>
                    <li><span><img src="images/brand1.png" alt="Stylexpo"></span></li>
  ...
  <section class="client-bg ptb-70">
    <div class="top-shadow">
      <img alt="Stylexpo" src="images/top-shadow.png">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
              ...
              <div id="client" class="owl-carousel">
                <div class="item client-detail">
                  <div class="client-img left-side mt-40">
                      <img alt="Stylexpo" src="images/testimonial_img1.jpg">
                  ...
                  <div class="quote right-side">
                    <div class="quote1-img">
                      <img src="images/quote1.png" alt="Stylexpo">
                    </div>
                    ...
                    <div class="quote2-img">
                      <img src="images/quote2.png" alt="Stylexpo">
                    </div>
                  </div>
                </div>
                <div class="item client-detail">
                  <div class="client-img left-side mt-40">
                      <img alt="Stylexpo" src="images/testimonial_img2.jpg">
                    <h4 class="sub-title client-title">- Joseph deboungawer - </h4>
                    <div class="designation">Maneger of Business  Development, 2base</div>
                  </div>
                ...
                <div class="item client-detail">
                  <div class="client-img left-side mt-40">
                      <img alt="Stylexpo" src="images/testimonial_img3.jpg">
                    <h4 class="sub-title client-title">- Joseph deboungawer - </h4>
                    <div class="designation">Maneger of Business  Development, 2base</div>
                  </div>
                  <div class="quote right-side">
    ...
    <div class="bottom-shadow">
      <img alt="Stylexpo" src="images/bottom-shadow.png">
    </div>
  </section>
        ...
        <div class="pro_cat">
          <div class="row">
            <div class="owl-carousel our-team ">
              <div class="item">
                <div class="team-item listing-effect col-sm-margin-b"> <img alt="Stylexpo" src="images/tm1.jpg">
              ...
              <div class="item">
                <div class="team-item listing-effect col-sm-margin-b"> <img alt="Stylexpo" src="images/tm2.jpg">
                  <div class="team-item-detail">
              ...
              <div class="item">
                <div class="team-item listing-effect col-sm-margin-b"> <img alt="Stylexpo" src="images/tm3.jpg">
                  <div class="team-item-detail">
                    <h3 class="sub-title listing-effect-title">Adamaris Corliss</h3>
                    <div class="listing-meta">Co-Founder</div>
                    <div class="social_icon">
              ...
              <div class="item">
                <div class="team-item listing-effect col-sm-margin-b"> <img alt="Stylexpo" src="images/tm4.jpg">
                  <div class="team-item-detail">
                    <h3 class="sub-title listing-effect-title">Adamaris Corliss</h3>
                    <div class="listing-meta">Co-Founder</div>
                    <div class="social_icon">
