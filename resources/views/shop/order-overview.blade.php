      ...
      <section class="banner-detail center-xs">
        ...
        <div class="bread-crumb right-side float-none-xs">
          <ul>
            ...
            <li><a href="cart.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/cart.html">Cart</a>/</li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="checkout-step mb-40">
            <ul>
              <li> 
                  <a href="checkout.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/checkout.html">
                  <div class="step">
                    <div class="line"></div>
              ...
              <li class="active"> 
                <a href="order-overview.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/order-overview.html">
                  <div class="step">
                    <div class="line"></div>
              ...
              <li> 
                <a href="payment.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/payment.html">
                  <div class="step">
                    <div class="line"></div>
              ...
              <li> 
                <a href="order-complete.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/order-complete.html">
                  <div class="step">
                    <div class="line"></div>
          ...
          <div class="checkout-content">
            ...
            <div class="row">
              <div class="col-md-8 mb-sm-30">
                <div class="cart-item-table commun-table mb-30">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td><a href="product-page.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/product-page.html">
                            <div class="product-image"><img alt="Honour" src="images/1.jpg" tppabs="http://aaryaweb.info/html/stylexpo/stx004/images/1.jpg"></div>
                            </a></td>
                          <td><div class="product-title"> <a href="product-page.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/product-page.html">Cross Colours Camo Print Tank half mengo</a>
                        ...
                        <tr>
                          <td><a href="product-page.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/product-page.html">
                            <div class="product-image"><img alt="Honour" src="images/2.jpg" tppabs="http://aaryaweb.info/html/stylexpo/stx004/images/2.jpg"></div>
                            </a></td>
                          <td><div class="product-title"> <a href="product-page.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/product-page.html">Cross Colours Camo Print Tank half mengo</a>
                              <div class="product-info-stock-sku m-0">
                                <div>
                ...
                <div class="right-side float-none-xs"> <a href="payment.html" tppabs="http://aaryaweb.info/html/stylexpo/stx004/payment.html" class="btn btn-color">Next</a> </div>
              </div>
              <div class="col-md-4">
